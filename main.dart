        ...
        return Column(
          ...
          children: [
            ...
            ListTile(
              ...
              title: Text('Arşivle', style: TextStyle(color: Colors.blue)),
              onTap: () {
                Navigator.pop(context);
      ...
      builder: (context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              child: Text('Arşivle', style: TextStyle(color: Colors.blue)),
              onPressed: () {
                ...
                children: _kategorileriGetir().map((kategori) {
                  return Padding(
                    ...
                    child: FilterChip(
                      ...
                      selectedColor: const Color.fromARGB(255, 33, 96, 243),
...
class ArsivSayfasi extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: arsivlenmisSayaclar.isEmpty
          ? Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
          ...
          : ListView.builder(
              padding: EdgeInsets.all(8),
              itemCount: arsivlenmisSayaclar.length,
              itemBuilder: (context, index) {
                final sayac = arsivlenmisSayaclar[index];
                final kalanSure = sayac.tarihSaat.difference(DateTime.now());
                final dateFormat = DateFormat('dd/MM/yyyy');
